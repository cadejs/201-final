...
public class QuizTime {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ShortAnswerQuestion s2 = new ShortAnswerQuestion("What book by Issac Asimov shares a name with a film featuring Will Smith?", "I Robot");
		...
		ShortAnswerQuestion s4 = new ShortAnswerQuestion("In the third sequel to the Hitch Hikers Guide to the Galaxy what animal serves itself in the restraunt at the end of the galaxy?", "a cow");
		ShortAnswerQuestion s5 = new ShortAnswerQuestion("The story Dune was based on the fall of what emprire? ", "The Roman");
		
		MultipleChoiceQuestion q1 = new MultipleChoiceQuestion("Who wrote The left Hand of Darkness? ","Le Guin","Harvey","Sam","You");
		...
		MultipleChoiceQuestion q3 = new MultipleChoiceQuestion("The movie Brazil, showcases which young actor who is killed by being engulfued by buracratic paperwork? ","Deniro","Freeman","Cummberbatch","DeVito");
		...
		MultipleChoiceQuestion q5 = new MultipleChoiceQuestion("What is the genere of science fiction that attempts to only use proved or theoretically possible science? ","Hard Science Fiction","I swear its true science fiction","Boolean Fiction","Nerd Fiction");
		...
		TrueFalseQuestion t3 = new TrueFalseQuestion("The Mule is a character from The Foundation who is really ugly so no one bothers him and thats why he can take over planets." , "False");
		...
		TrueFalseQuestion t5 = new TrueFalseQuestion("Bonus: If the case of a goverment collapse the supreme court will be transported to Asheville, North Carolina" , "True");
